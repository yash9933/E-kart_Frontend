...
const UpdateProduct = ({match}) => {
    ...
    const createProductForm = () => (
        <form >
          ...
          <button type="submit" onClick={onSubmit} className="btn btn-success my-3">
            Update Product
          </button>
        </form>
      );
    return (
        <Base title="Add a Title Here!" description="Welcome to product creation section" className="container bg-info p-4">
